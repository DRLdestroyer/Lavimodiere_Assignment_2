...
gameStates[2] = function(){
    ...
    if(score > highScore){
        ...
        ctx.font = "15px Arial";
        ctx.fillText("Press Enter to Start", c.width/2, c.height/2 + 20);
        ctx.fillText("Enter a Name to Save Your Score!", c.width/2, c.height/2 + 125);
        ctx.restore();

        //!pass score and name to app.js
        //save the score and name
        scoreValue = score;
        //nameValue = name;//name is deprecated
...
//---Score Screen---//!showcase score on new screen
